package com.example.materialdialoglibrary;
...
import com.example.materialdialoglibrary.enums.Duration;
...
public class MaterialStyledDialog extends DialogBase {
    ...
    private View initStyle(final Builder builder) {
        ...
        if (builder.title != null && builder.title.length() != 0) {
            ...
            dialogTitle.setTypeface(Typeface.createFromAsset(builder.context.getAssets(), "fonts/palanquin/Palanquin-Light.ttf"));
            dialogTitle.setTextColor(Color.WHITE);
            dialogTitle.setAllCaps(false);
        } else {
        ...
        if (builder.description != null && builder.description.length() != 0) {
            ...
            dialogDescription.setTypeface(Typeface.createFromAsset(builder.context.getAssets(), "fonts/palanquin/Palanquin-Light.ttf"));
            dialogDescription.setTextColor(Color.parseColor("#6190E8"));
            dialogDescription.setAllCaps(false);
