package id.my.fachrinaufal.app.bottomdialoglibrary;
...
public class BottomDialog {
    ...
    private Dialog initBottomDialog(final Builder builder) {
        ...
        if (builder.title != null) {
            ...
            vTitle.setTypeface(Typeface.createFromAsset(builder.context.getAssets(), "fonts/palanquin/Palanquin-Bold.ttf"));
            vTitle.setTextColor(Color.WHITE);
        }

        if (builder.content != null) {
            vContent.setText(builder.content);
            vContent.setTypeface(Typeface.createFromAsset(builder.context.getAssets(), "fonts/palanquin/Palanquin-Light.ttf"));
            vContent.setTextColor(Color.WHITE);
        }
        ...
        if (builder.btn_positive != null) {
            ...
            vPositive.setTypeface(Typeface.createFromAsset(builder.context.getAssets(), "fonts/palanquin/Palanquin-Regular.ttf"));
            vPositive.setTextColor(Color.WHITE);
        ...
        if (builder.btn_negative != null) {
            ...
            vNegative.setTextColor(Color.WHITE);
            vNegative.setTypeface(Typeface.createFromAsset(builder.context.getAssets(), "fonts/palanquin/Palanquin-Regular.ttf"));
